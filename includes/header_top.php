...
<!-- Меню для дектопа -->
<section class="dd-menu-dekstop-wrap">
	<div class="container">
		<div class="row">
			<div class="dd-menu">
				<ul>
					...
					<li>
						<a href="#">
							<span>Электорника</span><br>
							<span>и компьютеры</span>
						</a>
					</li>
					...
					<li>
						<a href="#">
							<span>игры, музыка</span><br>
							<span>и видеоозвучки</span>
						</a>
					</li>
				</ul>
			</div>	
				...
				<div class="dd-left-center">
					<div class="dd-box dd-box1">
						<ul>
							<li>
								<a href="#">
									<span>Гоблин рекомендует</span><br>
									<span>136 товаров</span>
								</a>
							</li>
							<li>
								<a href="#">
									<span>Товары с подарками</span><br>
					...
					<div class="dd-box dd-box2">
						<ul>
							<li>
								<a href="#">
									<span>Хиты октября</span><br>
									<span>14 товаров</span>
								</a>
							</li>
							<li>
								<a href="#">
									<span>Сделан видеоразбор</span><br>
									<span>249 товаров</span>
								</a>
							</li>
						</ul>
					</div>
