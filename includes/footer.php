             ...
             <div class="footer__flex clearfix">
               <div class="footer__left">
                 ...
                 <div class="footer__info">
                     ...
                     <p class="footer__p slogan">Купить из тупичка</p>
                 </div>       
             </div>
             <div class="footer__cooperate-block">
               <p class="footer__p cooperate">По поводу сотрудничества пишите: <span style="color: #a2a29c">shop@oper.ru</span> </p>
               <p class="footer__p copyright mob">&copy; 2016 Goblin EnterTorMent. Все права защищены.</p>
           </div>
       </div>
       <div class="footer__right">
         <div class="footer__actions"><p class="footer__p actions__boldtext">Узнать первым</p><p class="footer__p actions__text">об акциях, интересных поступлениях</p></div>
         <div class="footer__email">
           <form action="#">
             <input class="input-view input-view_width input__footer" type="text" value="" placeholder="Укажите свою почту">
             <input class="submit-view submit-view-width footer__submit" type="submit" value="Так">			
         </form>	
     </div>
     <div class="footer__bottom">
        <p class="footer__p copyright desk">&copy; 2016 Goblin EnterTorMent. Все права защищены.</p>
        <a href="#" class="footer__scroll-top desk__scroll"></a>
    </div>
</div>
</div>
</div>
