<a href="#log-in" name="modal">HELLO</a>
<div id="mask"></div>
<div  class="window" id="log-in">
	<div class="db-popaps-form1" >
		...
		<form action="#" method="post" class="db-form-1 form1">
			...
			<textarea name="text" class="textarea-view_db-popaps1" id="" cols="33" rows="8" placeholder="Ваш комментарий"></textarea><br>
...
<div class="window" >
	<div class="db-popaps-form2">
		...
		<form action="#" method="post" class="db-form-1">
			...
			<textarea name="text" class="textarea-view_db-popaps2" id="" cols="33" rows="8" placeholder="Ваш комментарий"></textarea><br>
			<input type="submit" name="submit" class="submit-view submit-view-width db-submit-popaps" value="Отправить сейчас">
		</form>
		<span class="db-close1 dd-close"></span>
	</div>
...
<div class="window" >
	<div class="db-popaps-form3">
		...
		<form action="#" method="post" class="db-form-1">
			...
			<textarea name="text" class="textarea-view_db-popaps3" id="" cols="33" rows="8" placeholder="Ваш комментарий"></textarea><br>
			<input type="submit" name="submit" class="submit-view submit-view-width db-submit-popaps" value="Отправить сейчас">
		</form>
